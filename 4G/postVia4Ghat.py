...
def patch_measurement(serial_conn, measurement, fiware_url):
    try:
        ...
        response = send_at_command(serial_conn, "AT+HTTPREAD")  
        print("Fiware Server Response:", response)

    except Exception as e:
        print(f"Error sending HTTP PATCH request: {e}")
        ...
        with serial.Serial(SERIAL_PORT, BAUD_RATE, timeout=TIMEOUT) as ser:
            ...
            while True:
                ...
                if measurement:
                    ...
                    patch_measurement(ser, measurement,fiware_url+"/4G_Measurement/attrs")
